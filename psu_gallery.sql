...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 26, 2018 at 11:33 AM
...
--
-- Database: `psu_gallery`
--

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_assets`
--

CREATE TABLE `bjwo6_assets` (
...
--
-- Dumping data for table `bjwo6_assets`
--

INSERT INTO `bjwo6_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(11, 1, 25, 30, 1, 'com_languages', 'com_languages', '{\"core.admin\":{\"7\":1}}'),
...
(56, 11, 26, 27, 2, 'com_languages.language.2', 'Belarusian (be-BY)', '{}'),
(57, 11, 28, 29, 2, 'com_languages.language.3', 'Русский (Россия)', '{}'),
(58, 1, 109, 110, 1, 'com_spsimpleportfolio', 'SP Simple Portfolio', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_associations`
--

CREATE TABLE `bjwo6_associations` (
...
--
-- Table structure for table `bjwo6_banners`
--

CREATE TABLE `bjwo6_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bjwo6_banner_clients`
--

CREATE TABLE `bjwo6_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `bjwo6_banner_tracks`
--

CREATE TABLE `bjwo6_banner_tracks` (
...
--
-- Table structure for table `bjwo6_categories`
--

CREATE TABLE `bjwo6_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bjwo6_categories`
--

INSERT INTO `bjwo6_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 987, '2018-04-05 09:45:31', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 987, '2018-04-05 09:45:31', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 987, '2018-04-05 09:45:31', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 987, '2018-04-05 09:45:31', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 987, '2018-04-05 09:45:31', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 987, '2018-04-05 09:45:31', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_contact_details`
--

CREATE TABLE `bjwo6_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bjwo6_content`
--

CREATE TABLE `bjwo6_content` (
...
--
-- Table structure for table `bjwo6_contentitem_tag_map`
--

CREATE TABLE `bjwo6_contentitem_tag_map` (
...
--
-- Table structure for table `bjwo6_content_frontpage`
--

CREATE TABLE `bjwo6_content_frontpage` (
...
--
-- Table structure for table `bjwo6_content_rating`
--

CREATE TABLE `bjwo6_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bjwo6_content_types`
--

CREATE TABLE `bjwo6_content_types` (
...
--
-- Dumping data for table `bjwo6_content_types`
--

INSERT INTO `bjwo6_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `bjwo6_core_log_searches`
--

CREATE TABLE `bjwo6_core_log_searches` (
...
--
-- Table structure for table `bjwo6_extensions`
--

CREATE TABLE `bjwo6_extensions` (
...
--
-- Dumping data for table `bjwo6_extensions`
--

INSERT INTO `bjwo6_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"3a4954d2ae36c83c6ff55cc5a395bda2\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1522949966}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":3,\"lastrun\":1522922805,\"unique_id\":\"9293047c63003f3435fe3a2115a39bef9cbee427\",\"interval\":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 10002, 'Belarusian', 'language', 'be-BY', '', 0, 1, 0, 0, '{\"name\":\"Belarusian\",\"type\":\"language\",\"creationDate\":\"2012-11-20\",\"author\":\"Dennis Hermatski\",\"copyright\":\"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved\",\"authorEmail\":\"sirdionisiy@gmail.com\",\"authorUrl\":\"www.joomla.com\",\"version\":\"3.2.1.2\",\"description\":\"be-BY site language\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 10002, 'Belarusianbe-BY', 'language', 'be-BY', '', 1, 1, 0, 0, '{\"name\":\"Belarusian (be-BY)\",\"type\":\"language\",\"creationDate\":\"2012-11-20\",\"author\":\"Dennis Hermatski\",\"copyright\":\"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved\",\"authorEmail\":\"sirdionisiy@gmail.com\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.2.1.2\",\"description\":\"be-BY administrator language\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);
INSERT INTO `bjwo6_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(10002, 0, 'Belarusian Language Pack', 'package', 'pkg_be-BY', '', 0, 1, 1, 0, '{\"name\":\"Belarusian Language Pack\",\"type\":\"package\",\"creationDate\":\"2013-05-01\",\"author\":\"Dennis Hermatski\",\"copyright\":\"Copyright (C) 2005 - 2013 Open Source Matters.\",\"authorEmail\":\"sirdionisiy@gmail.com\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.2.1.2\",\"description\":\"Joomla 3.2 Belarusian Language Package\",\"group\":\"\",\"filename\":\"pkg_be-BY\"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 0, 'Russian', 'language', 'ru-RU', '', 0, 1, 0, 0, '{\"name\":\"Russian\",\"type\":\"language\",\"creationDate\":\"2017-11-07\",\"author\":\"Russian Translation Team\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"smart@joomlaportal.ru\",\"authorUrl\":\"www.joomlaportal.ru\",\"version\":\"3.8.2.1\",\"description\":\"Russian language pack (site) for Joomla! 3.8.2\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10004, 0, 'ru-RU', 'language', 'ru-RU', '', 1, 1, 0, 0, '{\"name\":\"\\u0420\\u0443\\u0441\\u0441\\u043a\\u0438\\u0439 (ru-RU)\",\"type\":\"language\",\"creationDate\":\"2017-11-07\",\"author\":\"Russian Translation Team\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"smart@joomlaportal.ru\",\"authorUrl\":\"www.joomlaportal.ru\",\"version\":\"3.8.2.1\",\"description\":\"Russian language pack (administrator) for Joomla! 3.8.2\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10006, 0, 'Simple Image Gallery (by JoomlaWorks)', 'plugin', 'jw_sig', 'content', 0, 1, 1, 0, '{\"name\":\"Simple Image Gallery (by JoomlaWorks)\",\"type\":\"plugin\",\"creationDate\":\"January 29th, 2018\",\"author\":\"JoomlaWorks\",\"copyright\":\"Copyright (c) 2006 - 2018 JoomlaWorks Ltd. All rights reserved.\",\"authorEmail\":\"please-use-the-contact-form@joomlaworks.net\",\"authorUrl\":\"www.joomlaworks.net\",\"version\":\"3.6.0\",\"description\":\"JW_PLG_SIG_XML_DESC\",\"group\":\"\",\"filename\":\"jw_sig\"}', '{\"galleries_rootfolder\":\"images\",\"thb_width\":\"200\",\"thb_height\":\"160\",\"jpg_quality\":\"80\",\"cache_expire_time\":\"3600\",\"memoryLimit\":\"\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `bjwo6_fields`
--

CREATE TABLE `bjwo6_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_fields_categories`
--

CREATE TABLE `bjwo6_fields_categories` (
...
--
-- Table structure for table `bjwo6_fields_groups`
--

CREATE TABLE `bjwo6_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `bjwo6_fields_values`
--

CREATE TABLE `bjwo6_fields_values` (
...
--
-- Table structure for table `bjwo6_finder_filters`
--

CREATE TABLE `bjwo6_finder_filters` (
...
--
-- Table structure for table `bjwo6_finder_links`
--

CREATE TABLE `bjwo6_finder_links` (
...
--
-- Table structure for table `bjwo6_finder_links_terms0`
--

CREATE TABLE `bjwo6_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_finder_links_terms1`
--

CREATE TABLE `bjwo6_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms2`
--

CREATE TABLE `bjwo6_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms3`
--

CREATE TABLE `bjwo6_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms4`
--

CREATE TABLE `bjwo6_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms5`
--

CREATE TABLE `bjwo6_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms6`
--

CREATE TABLE `bjwo6_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms7`
--

CREATE TABLE `bjwo6_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms8`
--

CREATE TABLE `bjwo6_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_terms9`
--

CREATE TABLE `bjwo6_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_termsa`
--

CREATE TABLE `bjwo6_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_termsb`
--

CREATE TABLE `bjwo6_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_termsc`
--

CREATE TABLE `bjwo6_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_termsd`
--

CREATE TABLE `bjwo6_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_termse`
--

CREATE TABLE `bjwo6_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_links_termsf`
--

CREATE TABLE `bjwo6_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bjwo6_finder_taxonomy`
--

CREATE TABLE `bjwo6_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `bjwo6_finder_taxonomy`
--

INSERT INTO `bjwo6_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_finder_taxonomy_map`
--

CREATE TABLE `bjwo6_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_finder_terms`
--

CREATE TABLE `bjwo6_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_finder_terms_common`
--

CREATE TABLE `bjwo6_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `bjwo6_finder_terms_common`
--

INSERT INTO `bjwo6_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `bjwo6_finder_tokens`
--

CREATE TABLE `bjwo6_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bjwo6_finder_tokens_aggregate`
--

CREATE TABLE `bjwo6_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_finder_types`
--

CREATE TABLE `bjwo6_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_languages`
--

CREATE TABLE `bjwo6_languages` (
...
--
-- Dumping data for table `bjwo6_languages`
--

INSERT INTO `bjwo6_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 3),
(2, 56, 'be-BY', 'Belarusian (be-BY)', 'Беларуская', 'be', 'be_by', '', '', '', '', 1, 1, 2),
(3, 57, 'ru-RU', 'Русский (Россия)', 'Russian (Russia)', 'ru', 'ru_ru', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_menu`
--

CREATE TABLE `bjwo6_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bjwo6_menu`
--

INSERT INTO `bjwo6_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_SPSIMPLEPORTFOLIO', 'com-spsimpleportfolio', '', 'com-spsimpleportfolio', 'index.php?option=com_spsimpleportfolio', 'component', 1, 1, 1, 10007, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 43, 44, 0, '', 1),
(103, 'mainmenu', 'Galery', 'galery', '', 'galery', 'index.php?option=com_spsimpleportfolio&view=items', 'component', 1, 1, 1, 10007, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{\"show_filter\":\"1\",\"catid\":\"\",\"layout_type\":\"default\",\"columns\":\"3\",\"thumbnail_type\":\"masonry\",\"popup_image\":\"default\",\"limit\":\"12\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_image_css\":\"\",\"menu_text\":1,\"menu_show\":1,\"page_title\":\"\",\"show_page_heading\":\"\",\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}', 45, 46, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_menu_types`
--

CREATE TABLE `bjwo6_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `bjwo6_menu_types`
--

INSERT INTO `bjwo6_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_messages`
--

CREATE TABLE `bjwo6_messages` (
...
--
-- Table structure for table `bjwo6_messages_cfg`
--

CREATE TABLE `bjwo6_messages_cfg` (
...
--
-- Table structure for table `bjwo6_modules`
--

CREATE TABLE `bjwo6_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `bjwo6_modules`
--

INSERT INTO `bjwo6_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `bjwo6_modules_menu`
--

CREATE TABLE `bjwo6_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bjwo6_modules_menu`
--

INSERT INTO `bjwo6_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `bjwo6_newsfeeds`
--

CREATE TABLE `bjwo6_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_overrider`
--

CREATE TABLE `bjwo6_overrider` (
...
--
-- Table structure for table `bjwo6_postinstall_messages`
--

CREATE TABLE `bjwo6_postinstall_messages` (
...
--
-- Dumping data for table `bjwo6_postinstall_messages`
--

INSERT INTO `bjwo6_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `bjwo6_redirect_links`
--

CREATE TABLE `bjwo6_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_schemas`
--

CREATE TABLE `bjwo6_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bjwo6_schemas`
--

INSERT INTO `bjwo6_schemas` (`extension_id`, `version_id`) VALUES
...
--
-- Table structure for table `bjwo6_session`
--

CREATE TABLE `bjwo6_session` (
...
--
-- Dumping data for table `bjwo6_session`
--

INSERT INTO `bjwo6_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('29f4nspu2qimbdim15n1si2qr6', 1, 0, '1522924140', 'joomla|s:2488:\"\";', 987, 'kaselrap'),
('hmhormikrfg47353r64mc2cru6', 0, 1, '1522950181', 'joomla|s:664:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_spsimpleportfolio_items`
--

CREATE TABLE `bjwo6_spsimpleportfolio_items` (
...
--
-- Dumping data for table `bjwo6_spsimpleportfolio_items`
--

INSERT INTO `bjwo6_spsimpleportfolio_items` (`id`, `title`, `alias`, `catid`, `image`, `video`, `description`, `client`, `tagids`, `url`, `published`, `language`, `access`, `ordering`, `created_by`, `created`, `modified_by`, `modified`, `checked_out`, `checked_out_time`) VALUES
(1, 'Картина', 'picture', 0, 'images/powered_by.png', '', '<p>scadcsdsd</p>', '', '[\"1\",\"2\"]', '', 1, '*', 1, 0, 987, '2018-04-09 13:27:24', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_spsimpleportfolio_tags`
--

CREATE TABLE `bjwo6_spsimpleportfolio_tags` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL,
  `alias` varchar(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `bjwo6_spsimpleportfolio_tags`
--

INSERT INTO `bjwo6_spsimpleportfolio_tags` (`id`, `title`, `alias`) VALUES
(1, 'sdssd', 'sdssd'),
(2, 'assa', 'assa');
...
--
-- Table structure for table `bjwo6_tags`
--

CREATE TABLE `bjwo6_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `bjwo6_tags`
--

INSERT INTO `bjwo6_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 987, '2018-04-05 09:45:31', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_template_styles`
--

CREATE TABLE `bjwo6_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `bjwo6_template_styles`
--

INSERT INTO `bjwo6_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `bjwo6_ucm_base`
--

CREATE TABLE `bjwo6_ucm_base` (
...
--
-- Table structure for table `bjwo6_ucm_content`
--

CREATE TABLE `bjwo6_ucm_content` (
...
--
-- Table structure for table `bjwo6_ucm_history`
--

CREATE TABLE `bjwo6_ucm_history` (
...
--
-- Table structure for table `bjwo6_updates`
--

CREATE TABLE `bjwo6_updates` (
...
--
-- Table structure for table `bjwo6_update_sites`
--

CREATE TABLE `bjwo6_update_sites` (
...
--
-- Dumping data for table `bjwo6_update_sites`
--

INSERT INTO `bjwo6_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1522949967, ''),
...
(5, 'Simple Image Gallery', 'extension', 'https://cdn.joomlaworks.org/updates/sig.xml', 1, 0, ''),
(6, 'SP Simple Portfolio', 'extension', 'http://www.joomshaper.com/updates/com-sp-simple-portfolio.xml', 1, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_update_sites_extensions`
--

CREATE TABLE `bjwo6_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `bjwo6_update_sites_extensions`
--

INSERT INTO `bjwo6_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(2, 10005),
(3, 28),
...
--
-- Table structure for table `bjwo6_usergroups`
--

CREATE TABLE `bjwo6_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `bjwo6_usergroups`
--

INSERT INTO `bjwo6_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `bjwo6_users`
--

CREATE TABLE `bjwo6_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bjwo6_users`
--

INSERT INTO `bjwo6_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(987, 'Super User', 'kaselrap', 'kaselrap@gmail.com', '$2y$10$pkVHOxpcxyRTG3i.CP.4ZOeL6HS7fHZdLqk/VlE2w/MMPbylzFZPe', 0, 1, '2018-04-05 09:45:32', '2018-04-05 10:04:43', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_user_keys`
--

CREATE TABLE `bjwo6_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bjwo6_user_notes`
--

CREATE TABLE `bjwo6_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bjwo6_user_profiles`
--

CREATE TABLE `bjwo6_user_profiles` (
...
--
-- Table structure for table `bjwo6_user_usergroup_map`
--

CREATE TABLE `bjwo6_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bjwo6_user_usergroup_map`
--

INSERT INTO `bjwo6_user_usergroup_map` (`user_id`, `group_id`) VALUES
(987, 8);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_utf8_conversion`
--

CREATE TABLE `bjwo6_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bjwo6_utf8_conversion`
--

INSERT INTO `bjwo6_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `bjwo6_viewlevels`
--

CREATE TABLE `bjwo6_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `bjwo6_viewlevels`
--

INSERT INTO `bjwo6_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `bjwo6_assets`
--
ALTER TABLE `bjwo6_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_associations`
--
ALTER TABLE `bjwo6_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `bjwo6_banners`
--
ALTER TABLE `bjwo6_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_banner_clients`
--
ALTER TABLE `bjwo6_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `bjwo6_banner_tracks`
--
ALTER TABLE `bjwo6_banner_tracks`
...
--
-- Indexes for table `bjwo6_categories`
--
ALTER TABLE `bjwo6_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_contact_details`
--
ALTER TABLE `bjwo6_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `bjwo6_content`
--
ALTER TABLE `bjwo6_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `bjwo6_contentitem_tag_map`
--
ALTER TABLE `bjwo6_contentitem_tag_map`
...
--
-- Indexes for table `bjwo6_content_frontpage`
--
ALTER TABLE `bjwo6_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `bjwo6_content_rating`
--
ALTER TABLE `bjwo6_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `bjwo6_content_types`
--
ALTER TABLE `bjwo6_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `bjwo6_extensions`
--
ALTER TABLE `bjwo6_extensions`
...
--
-- Indexes for table `bjwo6_fields`
--
ALTER TABLE `bjwo6_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `bjwo6_fields_categories`
--
ALTER TABLE `bjwo6_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indexes for table `bjwo6_fields_groups`
--
ALTER TABLE `bjwo6_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `bjwo6_fields_values`
--
ALTER TABLE `bjwo6_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indexes for table `bjwo6_finder_filters`
--
ALTER TABLE `bjwo6_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `bjwo6_finder_links`
--
ALTER TABLE `bjwo6_finder_links`
...
--
-- Indexes for table `bjwo6_finder_links_terms0`
--
ALTER TABLE `bjwo6_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms1`
--
ALTER TABLE `bjwo6_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms2`
--
ALTER TABLE `bjwo6_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms3`
--
ALTER TABLE `bjwo6_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms4`
--
ALTER TABLE `bjwo6_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms5`
--
ALTER TABLE `bjwo6_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms6`
--
ALTER TABLE `bjwo6_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms7`
--
ALTER TABLE `bjwo6_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms8`
--
ALTER TABLE `bjwo6_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_terms9`
--
ALTER TABLE `bjwo6_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_termsa`
--
ALTER TABLE `bjwo6_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_termsb`
--
ALTER TABLE `bjwo6_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_termsc`
--
ALTER TABLE `bjwo6_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_termsd`
--
ALTER TABLE `bjwo6_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_termse`
--
ALTER TABLE `bjwo6_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_links_termsf`
--
ALTER TABLE `bjwo6_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bjwo6_finder_taxonomy`
--
ALTER TABLE `bjwo6_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_finder_taxonomy_map`
--
ALTER TABLE `bjwo6_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `bjwo6_finder_terms`
--
ALTER TABLE `bjwo6_finder_terms`
...
--
-- Indexes for table `bjwo6_finder_terms_common`
--
ALTER TABLE `bjwo6_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `bjwo6_finder_tokens`
--
ALTER TABLE `bjwo6_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `bjwo6_finder_tokens_aggregate`
--
ALTER TABLE `bjwo6_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `bjwo6_finder_types`
--
ALTER TABLE `bjwo6_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `bjwo6_languages`
--
ALTER TABLE `bjwo6_languages`
...
--
-- Indexes for table `bjwo6_menu`
--
ALTER TABLE `bjwo6_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_menu_types`
--
ALTER TABLE `bjwo6_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `bjwo6_messages`
--
ALTER TABLE `bjwo6_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `bjwo6_messages_cfg`
--
ALTER TABLE `bjwo6_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `bjwo6_modules`
--
ALTER TABLE `bjwo6_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_modules_menu`
--
ALTER TABLE `bjwo6_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `bjwo6_newsfeeds`
--
ALTER TABLE `bjwo6_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `bjwo6_overrider`
--
ALTER TABLE `bjwo6_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bjwo6_postinstall_messages`
--
ALTER TABLE `bjwo6_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `bjwo6_redirect_links`
--
ALTER TABLE `bjwo6_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `bjwo6_schemas`
--
ALTER TABLE `bjwo6_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `bjwo6_session`
--
ALTER TABLE `bjwo6_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `bjwo6_spsimpleportfolio_items`
--
ALTER TABLE `bjwo6_spsimpleportfolio_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bjwo6_spsimpleportfolio_tags`
--
ALTER TABLE `bjwo6_spsimpleportfolio_tags`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bjwo6_tags`
--
ALTER TABLE `bjwo6_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_template_styles`
--
ALTER TABLE `bjwo6_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `bjwo6_ucm_base`
--
ALTER TABLE `bjwo6_ucm_base`
...
--
-- Indexes for table `bjwo6_ucm_content`
--
ALTER TABLE `bjwo6_ucm_content`
...
--
-- Indexes for table `bjwo6_ucm_history`
--
ALTER TABLE `bjwo6_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `bjwo6_updates`
--
ALTER TABLE `bjwo6_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `bjwo6_update_sites`
--
ALTER TABLE `bjwo6_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `bjwo6_update_sites_extensions`
--
ALTER TABLE `bjwo6_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `bjwo6_usergroups`
--
ALTER TABLE `bjwo6_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_users`
--
ALTER TABLE `bjwo6_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bjwo6_user_keys`
--
ALTER TABLE `bjwo6_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `bjwo6_user_notes`
--
ALTER TABLE `bjwo6_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `bjwo6_user_profiles`
--
ALTER TABLE `bjwo6_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `bjwo6_user_usergroup_map`
--
ALTER TABLE `bjwo6_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `bjwo6_viewlevels`
--
ALTER TABLE `bjwo6_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `bjwo6_assets`
--
ALTER TABLE `bjwo6_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT for table `bjwo6_banners`
--
ALTER TABLE `bjwo6_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_banner_clients`
--
ALTER TABLE `bjwo6_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_categories`
--
ALTER TABLE `bjwo6_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `bjwo6_contact_details`
--
ALTER TABLE `bjwo6_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_content`
--
ALTER TABLE `bjwo6_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_content_types`
--
ALTER TABLE `bjwo6_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `bjwo6_extensions`
--
ALTER TABLE `bjwo6_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10008;
--
-- AUTO_INCREMENT for table `bjwo6_fields`
--
ALTER TABLE `bjwo6_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_fields_groups`
--
ALTER TABLE `bjwo6_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_finder_filters`
--
ALTER TABLE `bjwo6_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_finder_links`
--
ALTER TABLE `bjwo6_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_finder_taxonomy`
--
ALTER TABLE `bjwo6_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bjwo6_finder_terms`
--
ALTER TABLE `bjwo6_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_finder_types`
--
ALTER TABLE `bjwo6_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_languages`
--
ALTER TABLE `bjwo6_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `bjwo6_menu`
--
ALTER TABLE `bjwo6_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
--
-- AUTO_INCREMENT for table `bjwo6_menu_types`
--
ALTER TABLE `bjwo6_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bjwo6_messages`
--
ALTER TABLE `bjwo6_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_modules`
--
ALTER TABLE `bjwo6_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `bjwo6_newsfeeds`
--
ALTER TABLE `bjwo6_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_overrider`
--
ALTER TABLE `bjwo6_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `bjwo6_postinstall_messages`
--
ALTER TABLE `bjwo6_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `bjwo6_redirect_links`
--
ALTER TABLE `bjwo6_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_spsimpleportfolio_items`
--
ALTER TABLE `bjwo6_spsimpleportfolio_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bjwo6_spsimpleportfolio_tags`
--
ALTER TABLE `bjwo6_spsimpleportfolio_tags`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `bjwo6_tags`
--
ALTER TABLE `bjwo6_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bjwo6_template_styles`
--
ALTER TABLE `bjwo6_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `bjwo6_ucm_content`
--
ALTER TABLE `bjwo6_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_ucm_history`
--
ALTER TABLE `bjwo6_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_updates`
--
ALTER TABLE `bjwo6_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_update_sites`
--
ALTER TABLE `bjwo6_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `bjwo6_usergroups`
--
ALTER TABLE `bjwo6_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `bjwo6_users`
--
ALTER TABLE `bjwo6_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=988;
--
-- AUTO_INCREMENT for table `bjwo6_user_keys`
--
ALTER TABLE `bjwo6_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_user_notes`
--
ALTER TABLE `bjwo6_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bjwo6_viewlevels`
--
ALTER TABLE `bjwo6_viewlevels`
