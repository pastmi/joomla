...
foreach ($this->items as $gallery) {
    ...
    <div class="row mb-15">
        <?php if ($defaultResource) { ?>
            <div class="col-md-4 " style="width: <?php echo $this->params->get('thumb_width', 200); ?>; height: <?php echo $this->params->get('thumb_height', 200); ?>;">
                <?php if ($this->params->get('image_linkable')) { ?>
                <a href="<?php echo $mediaUrl . '/'. $defaultResource->getImage(); ?>" <?php echo $this->openLink; ?> class="<?php echo $this->modalClass;?>" rel="swipeboxgroup<?php echo $defaultResource->getGalleryId();?>" title="<?php echo $this->escape($defaultResource->getTitle()); ?>">
                <?php } ?>
                    ...
                    <div class="mg-additional-images">
                        ...
                        foreach ($resources as $resource) {
                            if ((int)$resource->home !== 1) {
                                ...
                                ?>
                                <a href="<?php echo $mediaUrl . '/' . $resource->image; ?>" <?php echo $this->openLink; ?> class="<?php echo $this->modalClass; ?>" rel="swipeboxgroup<?php echo $resource->gallery_id; ?>" title="<?php echo $this->escape($resource->title); ?>">
