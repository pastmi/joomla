    ...
    <div class="row mb-15">
        <?php if ($defaultResource !== null) { ?>
            <div class="col-md-4 col-sm-12 col-xs-12" style="width: <?php echo $this->params->get('thumb_width', 200); ?>; height: <?php echo $this->params->get('thumb_height', 200); ?>;">
                ...
                <a href="<?php echo $mediaUrl . '/' . $defaultResource->getImage(); ?>" <?php echo $this->openLink; ?> class="<?php echo $this->modalClass; ?>" rel="js-com-group<?php echo $defaultResource->getGalleryId(); ?>">
                    <?php } ?>
                    <img width="<?php echo $defaultWidth; ?>" height="<?php echo $defaultHeight; ?>" src="<?php echo $mediaUrl . '/' . $defaultResource->getThumbnail(); ?>" alt="<?php echo $this->escape($gallery->getTitle()); ?>" title="<?php echo $this->escape($gallery->getTitle()); ?>" class="thumbnail mb-5"/>
                    <?php if ($this->params->get('image_linkable')) { ?>
                </a>
            <?php } ?>
                    ...
                    <div class="mg-additional-images">
                        ...
                        foreach ($resources as $resource) {
                            if ((int)$resource->home !== 1) {
                                ...
                                ?>
                                <a href="<?php echo $mediaUrl . '/' . $resource->image; ?>" <?php echo $this->openLink; ?> class="<?php echo $this->modalClass; ?>" rel="js-com-group<?php echo $resource->gallery_id; ?>" title="<?php echo $this->escape($resource->title); ?>">
