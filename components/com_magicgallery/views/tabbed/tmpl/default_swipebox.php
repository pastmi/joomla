        ...
        <div class="row">
            ...
            foreach ($resources as $resource) {
                ...
                if ($this->params->get('title_max_charts', 0)) {
                    $titleCleanTruncated = JHtmlString::truncate($titleClean, $this->params->get('title_max_charts'));
                }
                ?>
                <?php if ($resource !== null and ($resource->image and $resource->thumbnail)) { ?>
                    <div class="col-xs-6 col-md-4">
                        <a href="<?php echo $gallery->getMediaUri() . '/' . $resource->image; ?>" <?php echo $this->openLink; ?> class="thumbnail mt-10 <?php echo $this->modalClass; ?>" rel="swipeboxgroup<?php echo $resource->gallery_id;?>" title="<?php echo $titleClean; ?>">
