...
<div class="row">
    <?php if(!empty($this->defaultResource)) { ?>
        <div class="col-md-4">
            ...
            <a href="<?php echo $this->item->media_uri .'/'. $this->defaultResource->getImage();?>" <?php echo $this->openLink;?> class="<?php echo $this->modalClass;?>" rel="swipeboxgroup<?php echo $this->item->id;?>" title="<?php echo $this->escape($this->defaultResource->getTitle()); ?>">
                <?php }?>
                <img
            ...
            <?php if ($this->params->get('display_additional_images', 0) and count($this->item->entities) > 0) {?>
                <div class="mg-additional-images">
                    ...
                    foreach ($resources as $resource) { ?>
                        <a href="<?php echo $this->item->media_uri .'/'. $resource->image;?>" <?php echo $this->openLink;?> class="<?php echo $this->modalClass;?>" rel="swipeboxgroup<?php echo $this->item->id;?>" title="<?php echo $this->escape($resource->title); ?>">
                            <img
