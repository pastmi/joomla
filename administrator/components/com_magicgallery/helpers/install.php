 ...
 */
class MagicgalleryInstallHelper
{
    ...
    public static function createFolder($path)
    {
        ...
        if (true !== JFolder::create($path)) {
            JLog::add(JText::sprintf("COM_MAGICGALLERY_ERROR_CANNOT_CREATE_FOLDER", $path));
        } else {
            ...
            if (true !== JFile::write($indexFile, $html)) {
                JLog::add(JText::sprintf("COM_MAGICGALLERY_ERROR_CANNOT_SAVE_FILE", $indexFile));
            }
        }
